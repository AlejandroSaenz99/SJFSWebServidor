...
router.post('/GuardarPago',middleware.isLoggedIn,routesController.GuardarPago);
...
router.get('/DeletePago/:Id',middleware.isLoggedIn,routesController.DeletePago);
...
router.get('/updatePagos/:Id',middleware.isLoggedIn,routesController.EditPagos);
